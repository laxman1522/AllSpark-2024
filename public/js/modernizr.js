 ...
 */ window.Modernizr = (function (e, t, n) {
  var r,
    ...
    w = function (e, n, r, o) {
      ...
      if (parseInt(r, 10))
        for (; r--; )
          ((u = t.createElement('div')).id = o ? o[r] : s + (r + 1)),
            d.appendChild(u);
      return (
        (a = ['&#173;', '<style id="s', s, '">', e, '</style>'].join('')),
        (d.id = s),
        ((f ? d : m).innerHTML += a),
        m.appendChild(d),
        f ||
        ...
        f
          ...
          : (m.parentNode.removeChild(m), (c.style.overflow = l)),
        !!i
      );
    },
    C = function (t) {
  ...
  for (var j in ((a =
    T(S, 'undefined') || T(S.call, 'undefined')
      ? function (e, t) {
      ...
      var r = $.call(arguments, 1),
        o = function () {
          if (!(this instanceof o))
            return n.apply(t, r.concat($.call(arguments)));
          var e = function () {};
          e.prototype = n.prototype;
          var a = new e(),
            i = n.apply(a, r.concat($.call(arguments)));
  ...
  (y.rgba = function () {
    return (
      _('background-color:rgba(150,255,150,.5)'), N(l.backgroundColor, 'rgba')
    );
  }),
  (y.hsla = function () {
    return (
      _('background-color:hsla(120,40%,100%,.5)'),
      N(l.backgroundColor, 'rgba') || N(l.backgroundColor, 'hsla')
    );
  }),
  (y.multiplebgs = function () {
    return (
      _('background:url(https://),url(https://),red url(https://)'),
    ...
    return (
      _(
        (
          ...
          m.join('linear-gradient(left top,#9f9, white);' + e)
        ).slice(0, -e.length),
      ),
      N(l.backgroundImage, 'gradient')
    );
  }),
  ...
  (y.fontface = function () {
    var e;
    return (
      w('@font-face {font-family:"font";src:url("https://")}', function (n, r) {
  ...
  (y.svg = function () {
    return (
      !!t.createElementNS && !!t.createElementNS(v.svg, 'svg').createSVGRect
    );
  }),
  (y.inlinesvg = function () {
    ...
    return (
      (e.innerHTML = '<svg/>'),
      (e.firstChild && e.firstChild.namespaceURI) == v.svg
    );
  }),
  (y.smil = function () {
    return (
      !!t.createElementNS &&
      /SVGAnimate/.test(f.call(t.createElementNS(v.svg, 'animate')))
    );
  }),
  (y.svgclippaths = function () {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(f.call(t.createElementNS(v.svg, 'clipPath')))
    );
  }),
  y))
    a(y, j) &&
      ((i[(o = j.toLowerCase())] = y[j]()), x.push((i[o] ? '' : 'no-') + o));
  return (
    i.input ||
      ((i.input = (function (n) {
        ...
        return (
          E.list &&
            (E.list = !!(t.createElement('datalist') && e.HTMLDataListElement)),
          E
        );
      })(
      ...
      (i.inputtypes = (function (e) {
        for (var r, o, a, i = 0, s = e.length; i < s; i++)
          d.setAttribute('type', (o = e[i])),
            (r = 'text' !== d.type) &&
              ((d.value = ':)'),
              (d.style.cssText = 'position:absolute;visibility:hidden;'),
              /^range$/.test(o) && n !== d.style.WebkitAppearance
                ? (c.appendChild(d),
                  (r =
                    (a = t.defaultView).getComputedStyle &&
                    'textfield' !==
                      a.getComputedStyle(d, null).WebkitAppearance &&
                    0 !== d.offsetHeight),
                  c.removeChild(d))
                : /^(search|tel)$/.test(o) ||
                  (r = /^(url|email)$/.test(o)
                    ? d.checkValidity && !1 === d.checkValidity()
                    : ':)' != d.value)),
            (b[e[i]] = !!r);
        return b;
      })(
    ...
    (i.addTest = function (e, t) {
      if ('object' == typeof e) for (var r in e) a(e, r) && i.addTest(r, e[r]);
      else {
    ...
    !(function (e, t) {
      ...
      function m(e) {
        ...
        var o,
          ...
          s,
          u = d(e);
        if (p.shivCSS && !n && !u.hasCSS) {
          u.hasCSS =
            ((a = (o = e).createElement('p')),
            (i = o.getElementsByTagName('head')[0] || o.documentElement),
            (a.innerHTML =
        ...
        return (
          !r &&
            ...
            (s = u).cache ||
              ((s.cache = {}),
              (s.createElem = c.createElement),
              (s.createFrag = c.createDocumentFragment),
              (s.frag = s.createFrag())),
              ...
              'return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(' +
                l()
                  ...
                  .replace(/[\w\-]+/g, function (e) {
                    return (
                      s.createElem(e), s.frag.createElement(e), 'c("' + e + '")'
                    );
                  }) +
                ');return n}',
            )(p, s.frag))),
    ...
    (c.className =
      c.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + ' js ' + x.join(' ')),
    i
  );
})(this, this.document);
