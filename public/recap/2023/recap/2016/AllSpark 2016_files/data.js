...
var EVENTS2016 = {
  ...
  B: [
    {
      ...
      presenters: [
        'Gopala Krishnan Srinivasan',
        ' Bhuvaneshwari Rajasekar',
        ' Veeraraghavan Ramachandran',
        ' Monica Ramireddi',
        'Manikanta Tankala',
        'Gabriela Jennifer',
        ' Sapna Jayavel',
  ...
  D: [
    ...
    },
    {
      ...
      presenters: [
        'Raguraman Krishnamoorthy',
        'Ramakrishnan Kuppusami',
        'Gabriela Jennifer',
      ],
      subitems: [],
      hall: 'B',
  ...
  F: [
    ...
    },
    {
      ...
      status: 'busy',
      topic:
        'Mobile Jam - Instant Mobile Browsing using AMP & Sirius Mobile Cloud',
      kind: 'breakout',
      category: '',
      color: 'blue',
  ...
  G: [
    ...
    },
    {
      ...
      presenters: [
        'Chandrakanth Gangaram',
        'Jeyanthi Veeramani',
        'Gautham Mukesh',
        'Tamilarasi Kalimuthu',
        'Gayathri Karunakaran',
        'Porkalai Arunan',
      ],
      subitems: [],
      hall: 'B',
