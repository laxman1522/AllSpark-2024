  ...
  [862],
  {
    ...
    3354: function (e, a, t) {
      ...
      var i = t(7437),
        ...
        s = t(5154),
        o = t.n(s);
      t(7810), t(2849), t(524), t(4159);
      var l = () =>
          (0, i.jsxs)('div', {
            className: o()['main-logo'],
            children: [
              (0, i.jsx)(n(), {
                src: '/logos/arrow-red.png',
                alt: 'arrow',
                className: o().arrow,
                priority: !0,
                width: 50,
        ...
        return (0, i.jsx)('div', {
          ...
          children: a
            ? (0, i.jsx)(n(), {
                src: a,
                alt: t,
                className: d()[''.concat(r)],
                priority: !0,
              })
            : (0, i.jsxs)('div', {
                className: d()['all-spark-logo'],
                children: [
                  (0, i.jsx)(n(), {
                    src: '/logos/arrow-red.png',
                    alt: 'arrow',
                  ...
                  (0, i.jsx)(n(), {
                    src: '/logos/llspark-with-line.png',
                    alt: 'spark logo',
                    className: d()['spark-logo'],
                    priority: !0,
                    width: 100,
                    height: 100,
                  }),
      ...
      let d = (e) => {
        ...
        return (
          (0, c.useEffect)(() => {
            ...
            return (
              e.set([u.current, g.current, p.current], { opacity: 0 }),
              e.fromTo(
                u.current,
                { opacity: 0, y: 50 },
