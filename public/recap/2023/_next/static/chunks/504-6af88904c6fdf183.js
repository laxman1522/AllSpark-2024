    ...
    504: function (n, t, a) {
      ...
      var q = B(
        ...
        V = B(
          ...
          s(d, U, { solid: 'fass', regular: 'fasr', light: 'fasl' }),
          d),
        ),
        G = B(
          (s((b = {}), H, {
          ...
          s(b, U, { fass: 'fa-solid', fasr: 'fa-regular', fasl: 'fa-light' }),
          b),
        ),
        K = B(
          (s((p = {}), H, {
        ...
        Z = B(
          ...
          s(v, U, { 900: 'fass', 400: 'fasr', 300: 'fasl' }),
          v),
        ),
      ...
      S &&
        'function' == typeof S.querySelector &&
        [
      ...
      var nf = r(r({}, ns), no);
      nf.autoReplaceSvg || (nf.observeMutations = !1);
      var nc = {};
      Object.keys(ns).forEach(function (n) {
        Object.defineProperty(nc, n, {
          enumerable: !0,
          set: function (t) {
            (nf[n] = t),
        ...
        Object.defineProperty(nc, 'familyPrefix', {
          enumerable: !0,
          set: function (n) {
            (nf.cssPrefix = n),
              nl.forEach(function (n) {
        ...
        (j.FontAwesomeConfig = nc);
      var nl = [],
        nu = { size: 16, x: 0, y: 0, rotate: 0, flipX: !1, flipY: !1 };
      function nm() {
        for (var n = 12, t = ''; n-- > 0; )
        ...
        nc.autoAddCss &&
          ...
          (!(function (n) {
            if (n && z) {
              ...
              for (
                var a = S.head.childNodes, e = null, r = a.length - 1;
                r > -1;
                r--
              ) {
                var i = a[r];
      ...
      var nw = j || {};
      nw[I] || (nw[I] = {}),
        nw[I].styles || (nw[I].styles = {}),
        nw[I].hooks || (nw[I].hooks = {}),
        nw[I].shims || (nw[I].shims = []);
      var nx = nw[I],
        nO = [],
        nA = !1;
      function nN(n) {
        ...
        return 'string' == typeof n
          ...
          : '<'
              .concat(a, ' ')
              .concat(
                Object.keys((t = void 0 === e ? {} : e) || {})
                  .reduce(function (n, a) {
                    return n + ''.concat(a, '="').concat(np(t[a]), '" ');
                  }, '')
                  .trim(),
                '>',
              )
              .concat((void 0 === r ? [] : r).map(nN).join(''), '</')
              .concat(a, '>');
      }
      function nP(n, t, a) {
        if (n && n[t] && n[t][a])
      ...
      !z ||
        ...
        S.addEventListener('DOMContentLoaded', function n() {
      ...
      function nE(n, t) {
        var a =
          ...
          e = a.skipHooks,
          i = nC(t);
        'function' != typeof nx.hooks.addPack || (void 0 !== e && e)
          ? (nx.styles[n] = r(r({}, nx.styles[n] || {}), i))
          : nx.hooks.addPack(n, nC(t)),
          'fas' === n && nE('fa', t);
      }
      var nz = nx.styles,
        nM = nx.shims,
        nI =
          (s((g = {}), H, Object.values(G[H])),
        ...
        nD = {},
        nF = {},
        nW = (s((h = {}), H, Object.keys(q[H])), s(h, U, Object.keys(q[U])), h),
        n_ = function () {
          var n = function (n) {
            return nj(
              nz,
          ...
          var t = 'far' in nz || nc.autoFetchSvg,
            a = nj(
              nM,
              function (n, a) {
                var e = a[0],
          ...
          (nT = a.names),
            (nD = a.unicodes),
            (nL = nq(nc.styleDefault, { family: nc.familyDefault }));
        };
      function nH(n, t) {
        return (nR[n] || {})[t];
      }
      ...
      function nX(n) {
        return nT[n] || { prefix: null, iconName: null };
      }
      nl.push(function (n) {
        nL = nq(n.styleDefault, { family: nc.familyDefault });
      }),
        n_();
      var nB = function () {
      ...
      var nV =
        (s((y = {}), H, Object.keys(G[H])), s(y, U, Object.keys(G[U])), y);
      function nG(n) {
        var t,
          a =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          r = void 0 !== e && e,
          i =
            (s((t = {}), H, ''.concat(nc.cssPrefix, '-').concat(H)),
            s(t, U, ''.concat(nc.cssPrefix, '-').concat(U)),
            t),
          o = null,
          f = H;
        (n.includes(i[H]) ||
        ...
        var c = n.reduce(function (n, t) {
          var a,
            ...
            l =
              ...
              (s = (e = t.split('-'))[0]),
              (c = e.slice(1).join('-')),
              s !== a || '' === c || ~ni.indexOf(c) ? null : c);
          if (
            (nz[t]
              ? ((o = t = nI[f].includes(t) ? K[f][t] : t), (n.prefix = t))
              : nW[f].indexOf(t) > -1
                ? ((o = t), (n.prefix = nq(t, { family: f })))
                : l
                  ? (n.iconName = l)
                  : t !== nc.replacementClass &&
                    t !== i[H] &&
        ...
        return (
          ...
          !c.prefix &&
            f === U &&
            (nz.fass || nc.autoFetchSvg) &&
            ((c.prefix = 'fass'),
            (c.iconName = nU(c.prefix, c.iconName) || c.iconName)),
          ('fa' === c.prefix || 'fa' === o) && (c.prefix = nL || 'fas'),
          c
        );
      }
      var nK = (function () {
            ...
            (n = [
              {
                ...
                value: function () {
                  for (
                    var n = this, t = arguments.length, a = Array(t), e = 0;
                    e < t;
                    e++
                  )
                    a[e] = arguments[e];
      ...
      function n1(n, t) {
        for (
          var a = arguments.length, e = Array(a > 2 ? a - 2 : 0), r = 2;
          r < a;
          r++
        )
          e[r - 2] = arguments[r];
      ...
      function n0(n) {
        for (
          var t = arguments.length, a = Array(t > 1 ? t - 1 : 0), e = 1;
          e < t;
          e++
        )
          a[e - 1] = arguments[e];
      ...
      function n5(n) {
        ...
        if (t)
          return (
            (t = nU(a, t) || t), nP(n4.definitions, a, t) || nP(nx.styles, a, t)
          );
      }
      var n4 = new nK(),
        n6 = {
          noAuto: function () {
            (nc.autoReplaceSvg = !1), (nc.observeMutations = !1), n0('noAuto');
          },
          config: nc,
          dom: {
            i2svg: function () {
            ...
            watch: function () {
              ...
              !1 === nc.autoReplaceSvg && (nc.autoReplaceSvg = !0),
                (nc.observeMutations = !0),
                (n = function () {
                  n3({ autoReplaceSvgRoot: a }), n0('watch', t);
                }),
            ...
            icon: function (n) {
              ...
              if (Array.isArray(n) && 2 === n.length) {
                var t = 0 === n[1].indexOf('fa-') ? n[1].slice(3) : n[1],
                  a = nq(n[0]);
                return { prefix: a, iconName: nU(a, t) || t };
              }
              if (
                'string' == typeof n &&
                (n.indexOf(''.concat(nc.cssPrefix, '-')) > -1 || n.match($))
              ) {
                var e = nG(n.split(' '), { skipLookups: !0 });
                return {
                  prefix: e.prefix || nL,
              ...
              if ('string' == typeof n) {
                var r = nL;
                return { prefix: r, iconName: nU(r, n) || n };
              }
            },
          },
          library: n4,
        ...
        n3 = function () {
          var n =
            ...
            a = void 0 === t ? S : t;
          (Object.keys(nx.styles).length > 0 || nc.autoFetchSvg) &&
            z &&
            nc.autoReplaceSvg &&
            n6.dom.i2svg({ node: a });
        };
      ...
      function n9(n) {
        var t,
          ...
          A = [
            nc.replacementClass,
            m ? ''.concat(nc.cssPrefix, '-').concat(m) : '',
          ]
            .filter(function (n) {
          ...
          P =
            O && !~h.classes.indexOf('fa-fw')
              ? { width: ''.concat((w / x) * 1, 'em') }
              : {};
        void 0 !== y && y && (N.attributes[R] = ''),
          p &&
            (N.children.push({
              tag: 'title',
              attributes: {
                id:
                  N.attributes['aria-labelledby'] || 'title-'.concat(g || nm()),
              },
              children: [p],
            }),
        ...
        var j = r(
            ...
            {},
            {
              ...
              transform: d,
              symbol: b,
              styles: r(r({}, P), h.styles),
            },
          ),
          S =
            l.found && c.found
              ? n2('generateAbstractMask', j) || {
                  children: [],
                  attributes: {},
                }
          ...
          C = S.children,
          E = S.attributes;
        return ((j.children = C), (j.attributes = E), b)
          ? ((t = j.prefix),
            (a = j.iconName),
            (e = j.children),
            (i = j.attributes),
            (s =
              !0 === (o = j.symbol)
                ? ''.concat(t, '-').concat(nc.cssPrefix, '-').concat(a)
                : o),
            [
              {
                tag: 'svg',
      ...
      function n8(n) {
        ...
        ng(m) &&
          ((g.transform =
            ((a = (t = { transform: m, startCentered: !0, width: l, height: u })
              .transform),
            (e = t.width),
            (i = t.height),
            ...
            s && M
              ? (f += 'translate('
                  .concat(a.x / 16 - (void 0 === e ? 16 : e) / 2, 'em, ')
                  .concat(a.y / 16 - (void 0 === i ? 16 : i) / 2, 'em) '))
              : s
                ? (f += 'translate(calc(-50% + '
                    .concat(a.x / 16, 'em), calc(-50% + ')
                    .concat(a.y / 16, 'em)) '))
                : (f += 'translate('
                    .concat(a.x / 16, 'em, ')
                    .concat(a.y / 16, 'em) ')),
            (f +=
              ...
              'rotate('.concat(a.rotate, 'deg) ')))),
          (g['-webkit-transform'] = g.transform));
        var h = nv(g);
        h.length > 0 && (v.style = h);
        var y = [];
        return (
          y.push({ tag: 'span', attributes: v, children: [c] }),
          d &&
            y.push({
              tag: 'span',
        ...
        return {
          ...
          icon: Array.isArray(e)
            ? {
                tag: 'g',
                attributes: {
                  class: ''.concat(nc.cssPrefix, '-').concat(ne.GROUP),
                },
                children: [
                  {
                    tag: 'path',
                    attributes: {
                      class: ''.concat(nc.cssPrefix, '-').concat(ne.SECONDARY),
                      fill: 'currentColor',
                      d: e[0],
                    },
                  },
                  {
                    tag: 'path',
                    attributes: {
                      class: ''.concat(nc.cssPrefix, '-').concat(ne.PRIMARY),
                      fill: 'currentColor',
                      d: e[1],
                    },
                  },
      ...
      var ta = { found: !1, width: 512, height: 512 };
      function te(n, t) {
        var a = t;
        return (
          'fa' === t && null !== nc.styleDefault && (t = nL),
          new Promise(function (e, i) {
            if ((n2('missingIconAbstract'), 'fa' === a)) {
              var o,
                s,
                f = nX(n) || {};
              (n = f.iconName || n), (t = f.prefix || t);
            }
            ...
            (o = n),
              ...
              e(
                r(
                  ...
                  {
                    icon:
                      (nc.showMissingIcons && n && n2('missingIconAbstract')) ||
                      {},
                  },
                ),
              );
      ...
      var tr = function () {},
        ti =
          nc.measurePerformance && E && E.mark && E.measure
            ? E
            : { mark: tr, measure: tr },
        to = 'FA "6.4.2"',
        ts = function (n) {
          ti.mark(''.concat(to, ' ').concat(n, ' ends')),
            ti.measure(
              ''.concat(to, ' ').concat(n),
              ''.concat(to, ' ').concat(n, ' begins'),
              ''.concat(to, ' ').concat(n, ' ends'),
            );
        },
        tf = {
          begin: function (n) {
            return (
              ti.mark(''.concat(to, ' ').concat(n, ' begins')),
              function () {
                return ts(n);
              }
            );
        ...
        tc = function () {};
      function tl(n) {
        return 'string' == typeof (n.getAttribute ? n.getAttribute(R) : null);
      }
      function tu(n) {
      ...
      var td = {
        ...
        nest: function (n) {
          var t = n[0],
            a = n[1];
          if (~nb(t).indexOf(nc.replacementClass)) return td.replace(n);
          var e = new RegExp(''.concat(nc.cssPrefix, '-.*'));
          if ((delete a[0].attributes.id, a[0].attributes.class)) {
            var r = a[0].attributes.class.split(' ').reduce(
              function (n, t) {
                return (
                  t === nc.replacementClass || t.match(e)
                    ? n.toSvg.push(t)
                    : n.toNode.push(t),
                  n
                );
          ...
          var i = a
            ...
            .join('\n');
          t.setAttribute(R, ''), (t.innerHTML = i);
        },
      };
      function tb(n) {
        n();
      ...
      function tp(n, t) {
        var a = 'function' == typeof t ? t : tc;
        if (0 === n.length) a();
        else {
          var e = tb;
          'async' === nc.mutateApproach && (e = j.requestAnimationFrame || tb),
            e(function () {
              var t =
                  !0 === nc.autoReplaceSvg
                    ? td.replace
                    : td[nc.autoReplaceSvg] || td.replace,
                e = tf.begin('mutate');
              n.map(t), e(), a();
            });
        }
              ...
              nd(n).forEach(function (n) {
                if (
                  ('childList' === n.type &&
                    ...
                    !tl(n.addedNodes[0]) &&
                    (nc.searchPseudoElements && o(n.target), a(n.target)),
                  'attributes' === n.type &&
                    n.target.parentNode &&
                    nc.searchPseudoElements &&
                    o(n.target.parentNode),
                  'attributes' === n.type &&
                    tl(n.target) &&
                    ~na.indexOf(n.attributeName))
                ) {
                  if (
                    'class' === n.attributeName &&
                    ((i = (e = n.target).getAttribute
                      ? e.getAttribute(T)
                      : null),
                    ...
                    var e,
                      ...
                      l = c.prefix,
                      u = c.iconName;
                    n.target.setAttribute(T, l || t),
                      u && n.target.setAttribute(D, u);
                  } else
                    (f = n.target) &&
                      f.classList &&
                      f.classList.contains &&
                      f.classList.contains(nc.replacementClass) &&
                      r(n.target);
                }
              });
            }
      ...
      function ty(n) {
        var t,
          ...
          b =
            ...
            (s = nG(nb(n))).prefix || (s.prefix = nL),
            e && i && ((s.prefix = e), (s.iconName = i)),
            (s.iconName && s.prefix) ||
              (s.prefix &&
                o.length > 0 &&
                (s.iconName =
                  ((t = s.prefix),
                  (a = n.innerText),
                  (nY[t] || {})[a] || nH(s.prefix, nS(n.innerText)))),
              !s.iconName &&
                nc.autoFetchSvg &&
                n.firstChild &&
                n.firstChild.nodeType === Node.TEXT_NODE &&
                (s.iconName = n.firstChild.data)),
            s),
          p = b.iconName,
          v = b.prefix,
          g = b.rest,
          h =
            ((f = nd(n.attributes).reduce(function (n, t) {
              return (
                'class' !== n.name &&
                  'style' !== n.name &&
                  (n[t.name] = t.value),
            ...
            (c = n.getAttribute('title')),
            (l = n.getAttribute('data-fa-title-id')),
            nc.autoA11y &&
              (c
                ? (f['aria-labelledby'] = ''
                    .concat(nc.replacementClass, '-title-')
                    .concat(l || nm()))
                : ((f['aria-hidden'] = 'true'), (f.focusable = 'false'))),
            f),
          y = n1('parseNodeAttributes', {}, n),
          k = d.styleParser
            ? ((u = n.getAttribute('style')),
              (m = []),
              u &&
                (m = u.split(';').reduce(function (n, t) {
                  var a = t.split(':'),
                    e = a[0],
                    r = a.slice(1);
                  return e && r.length > 0 && (n[e] = r.join(':').trim()), n;
                }, {})),
              m)
            : [];
        return r(
      ...
      function tw(n) {
        var t =
          'nest' === nc.autoReplaceSvg ? ty(n, { styleParser: !1 }) : ty(n);
        return ~t.extra.classes.indexOf(J)
          ? n2('generateLayersText', n, t)
      ...
      function tO(n) {
        ...
        var o = ['.'.concat(J, ':not([').concat(R, '])')]
          .concat(
            i.map(function (n) {
              return '.'.concat(n, ':not([').concat(R, '])');
            }),
          )
          .join(', ');
        ...
        var f = tf.begin('onTree'),
          c = s.reduce(function (n, t) {
            try {
              var a = tw(t);
              a && n.push(a);
            } catch (n) {
              _ || 'MissingIcon' !== n.name || console.error(n);
            }
            return n;
          }, []);
      ...
      var tN = function (n) {
          ...
          if (n) {
            var w = n.prefix,
              x = n.iconName,
              O = n.icon;
            return n7(r({ type: 'icon' }, n), function () {
              return (
      ...
      function tj(n, t) {
        ...
        return new Promise(function (e, i) {
          ...
          var o = nd(n.children).filter(function (n) {
              return n.getAttribute(Y) === t;
            })[0],
            s = j.getComputedStyle(n, t),
            f = s.getPropertyValue('font-family').match(Q),
            c = s.getPropertyValue('font-weight'),
            l = s.getPropertyValue('content');
          if (o && !f) return n.removeChild(o), e();
          if (f && 'none' !== l && '' !== l) {
            var u = s.getPropertyValue('content'),
              m = ~['Sharp'].indexOf(f[2]) ? U : H,
              d = ~[
                'Solid',
                'Regular',
                'Light',
              ...
              b =
                ...
                (N =
                  ...
                  x <= 57343
                    ...
                    : A),
                {
                  value: (P = 2 === k.length && k[0] === k[1])
                    ? nS(k[0])
                    : nS(k),
                  isSecondary: (N >= 1105920 && N <= 1112319) || P,
                }),
              p = b.value,
              v = b.isSecondary,
            ...
            if (
              !h ||
              v ||
              (o && o.getAttribute(T) === d && o.getAttribute(D) === y)
            )
              e();
            else {
      ...
      function tC(n) {
        return (
          ...
          !~W.indexOf(n.tagName.toUpperCase()) &&
          !n.getAttribute(Y) &&
          ...
          return n
            ...
            .reduce(
              function (n, t) {
                ...
                if (isNaN((r = parseFloat(r)))) return n;
                switch (e) {
                  case 'grow':
                    n.size = n.size + r;
                    break;
      ...
      (n$ = [
        {
          mixout: function () {
            return { dom: { css: nh, insertCss: nk } };
          },
          hooks: function () {
            return {
          ...
          hooks: function () {
            return {
              mutationObserverCallbacks: function (n) {
                return (n.treeCallback = tO), (n.nodeCallback = tA), n;
              },
            };
          },
          provides: function (n) {
            (n.i2svg = function (n) {
              var t = n.node,
                a = void 0 === t ? S : t,
                e = n.callback;
              return tO(a, void 0 === e ? function () {} : e);
            }),
              ...
              (n.generateAbstractIcon = function (n) {
                ...
                return (
                  ...
                  ng(i) &&
                    (t = n2('generateAbstractTransformGrouping', {
                      main: r,
                      transform: i,
            ...
            return {
              layer: function (n) {
                var t =
                  ...
                  a = t.classes,
                  e = void 0 === a ? [] : a;
                return n7({ type: 'layer' }, function () {
                  n0('beforeDOMElementCreation', { assembler: n, params: t });
                  var a = [];
                  return (
                    n(function (n) {
                      Array.isArray(n)
                    ...
                    [
                      {
                        tag: 'span',
                        attributes: {
                          class: [''.concat(nc.cssPrefix, '-layers')]
                            .concat(c(e))
                            .join(' '),
                        },
                        children: a,
            ...
            return {
              counter: function (n) {
                var t =
                  ...
                  l = t.styles,
                  u = void 0 === l ? {} : l;
                return n7({ type: 'counter', content: n }, function () {
                  var a, i, s, l, m, d, b;
                  return (
                    n0('beforeDOMElementCreation', { content: n, params: t }),
                    (i = (a = {
                      content: n.toString(),
                      title: e,
                      extra: {
                        ...
                        styles: u,
                        classes: [
                          ''.concat(nc.cssPrefix, '-layers-counter'),
                        ].concat(c(o)),
                      },
                    }).content),
                    (s = a.title),
                    (m = r(
                      r(r({}, (l = a.extra).attributes), s ? { title: s } : {}),
                      {},
        ...
        },
        {
            ...
            return {
              text: function (n) {
                var t =
                  ...
                  m = t.styles,
                  d = void 0 === m ? {} : m;
                return n7({ type: 'text', content: n }, function () {
                  return (
                    n0('beforeDOMElementCreation', { content: n, params: t }),
                    n8({
                      content: n,
                      ...
                      extra: {
                        ...
                        styles: d,
                        classes: [
                          ''.concat(nc.cssPrefix, '-layers-text'),
                        ].concat(c(f)),
                      },
                    })
                  );
          ...
          provides: function (n) {
            n.generateLayersText = function (n, t) {
              ...
              return (
                nc.autoA11y && !a && (r.attributes['aria-hidden'] = 'true'),
                Promise.resolve([
                  n,
                  n8({
                    content: n.innerHTML,
          ...
          provides: function (n) {
            n.generateAbstractTransformGrouping = function (n) {
              var t = n.main,
                ...
                c = { transform: ''.concat(o, ' ').concat(s, ' ').concat(f) },
                l = {
                  outer: { transform: 'translate('.concat(e / 2, ' 256)') },
                  inner: c,
                  path: {
          ...
          provides: function (n) {
            n.generateAbstractMask = function (n) {
              var t,
                ...
                y = d.icon,
                k =
                  ((a = (t = { transform: p, containerWidth: h, iconWidth: v })
                    .transform),
                  (e = t.containerWidth),
                  (i = t.iconWidth),
                  (o = 'translate('
                ...
                w = {
                  tag: 'rect',
                  attributes: r(r({}, tI), {}, { fill: 'white' }),
                },
                x = g.children ? { children: g.children.map(tL) } : {},
                O = {
                  tag: 'g',
        ...
        },
        {
          provides: function (n) {
            var t = !1;
            j.matchMedia &&
              (t = j.matchMedia('(prefers-reduced-motion: reduce)').matches),
      ...
      function t_(n) {
        for (var t = 1; t < arguments.length; t++) {
          var a = null != arguments[t] ? arguments[t] : {};
          t % 2
            ? tW(Object(a), !0).forEach(function (t) {
                tU(n, t, a[t]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(a))
              : tW(Object(a)).forEach(function (t) {
                  Object.defineProperty(
                    n,
                    t,
                    Object.getOwnPropertyDescriptor(a, t),
      ...
      function tX(n) {
        return (
          (function (n) {
            if (Array.isArray(n)) return tB(n);
          })(n) ||
          (function (n) {
            if (
              ('undefined' != typeof Symbol && null != n[Symbol.iterator]) ||
          ...
          (function (n, t) {
            if (n) {
              if ('string' == typeof n) return tB(n, t);
              var a = Object.prototype.toString.call(n).slice(8, -1);
              if (
                ('Object' === a && n.constructor && (a = n.constructor.name),
                'Map' === a || 'Set' === a)
      ...
      function tK(n) {
        return n && 'object' === tH(n) && n.prefix && n.iconName && n.icon
          ? n
          : tR.icon
            ? tR.icon(n)
            : null === n
              ? null
              : n && 'object' === tH(n) && n.prefix && n.iconName
                ? n
      ...
      var tJ = tF.forwardRef(function (n, t) {
        var a,
          ...
          M = tY(
            ...
            t_(
              t_(t_(t_({}, C), E), z),
              {},
              { symbol: O, title: N, titleId: P, maskId: j },
            ),
          );
        if (!M)
          return (
        ...
        return (
          Object.keys(n).forEach(function (t) {
            tJ.defaultProps.hasOwnProperty(t) || (I[t] = n[t]);
          }),
          tQ(M.abstract[0], I)
        );
      });
      ...
      var tQ = function n(t, a) {
                ...
                case 'style':
                  n.attrs.style = e
                    ...
                    .reduce(function (n, t) {
                      ...
                      return (
                        e.startsWith('webkit')
                          ? (n[e.charAt(0).toUpperCase() + e.slice(1)] = r)
                          : (n[e] = r),
                        n
                      );
                    }, {});
        ...
        return (
          (i.attrs.style = t_(t_({}, i.attrs.style), s)),
          t.apply(void 0, [a.tag, t_(t_({}, i.attrs), f)].concat(tX(r)))
        );
