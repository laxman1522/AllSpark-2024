...
const SectionHeader: React.FC<SectionHeaderProps> = ({ headerText }) => {
  return (
    <div className="section-header-wrapper pr-12 max-[767px]:mt-[2vh] flex max-[767px]:justify-center items-center font-bold text-[35px] max-[767px]:text-[20px] md:text-[28px] text-[#f3baa7] mb-0 gap-5 max-[767px]:gap-2">
